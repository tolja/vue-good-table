...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('lodash.foreach'), require('lodash.assign'), require('lodash.clonedeep'), require('lodash.filter'), require('lodash.isequal'), require('diacriticless'), require('date-fns')) :
  typeof define === 'function' && define.amd ? define(['exports', 'lodash.foreach', 'lodash.assign', 'lodash.clonedeep', 'lodash.filter', 'lodash.isequal', 'diacriticless', 'date-fns'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['vue-good-table'] = {}, global.each, global.assign, global.cloneDeep, global.filter, global.isEqual, global.diacriticless, global.dateFns));
}(this, (function (exports, each, assign, cloneDeep, filter, isEqual, diacriticless, dateFns) { 'use strict';
  ...
  var diacriticless__default = /*#__PURE__*/_interopDefaultLegacy(diacriticless);
  ...
  var defaultType = {
    ...
    filterPredicate: function filterPredicate(rowval, filter) {
      ...
      var rowValue = skipDiacritics ? String(rowval).toLowerCase() : diacriticless__default['default'](escapeRegExp(String(rowval)).toLowerCase()); // search term

      var searchTerm = skipDiacritics ? filter.toLowerCase() : diacriticless__default['default'](escapeRegExp(filter).toLowerCase()); // comparison
    ...
    compare: function compare(x, y) {
      function cook(d) {
        ...
        return diacriticless__default['default'](d.toLowerCase());
      }
    ...
    methods: {
      ...
      handlePerPage: function handlePerPage() {
        ...
        if (this.customRowsPerPageDropdown !== null && Array.isArray(this.customRowsPerPageDropdown) && this.customRowsPerPageDropdown.length !== 0) {
          this.rowsPerPageOptions = cloneDeep__default['default'](this.customRowsPerPageDropdown);
        } else {
          //* otherwise we use the default rows per page dropdown
          this.rowsPerPageOptions = cloneDeep__default['default'](DEFAULT_ROWS_PER_PAGE_DROPDOWN);
        }
  ...
  var script$4 = {
    ...
    methods: {
      ...
      getHeaderClasses: function getHeaderClasses(column, index) {
        var classes = assign__default['default']({}, this.getClasses(index, 'th'), {
  ...
  var date = cloneDeep__default['default'](defaultType);
  date.isRight = true;
  ...
  var number = cloneDeep__default['default'](defaultType);
  number.isRight = true;
  ...
  var decimal = cloneDeep__default['default'](number);
  ...
  var percentage = cloneDeep__default['default'](number);
  ...
  var _boolean = cloneDeep__default['default'](defaultType);
  ...
  each__default['default'](Object.keys(coreDataTypes), function (key) {
  ...
  var script$6 = {
    ...
    computed: {
      ...
      selectedPageRows: function selectedPageRows() {
        var selectedRows = [];
        each__default['default'](this.paginated, function (headerRow) {
      ...
      selectedRows: function selectedRows() {
        var selectedRows = [];
        each__default['default'](this.processedRows, function (headerRow) {
          each__default['default'](headerRow.children, function (row) {
            if (row.vgtSelected) {
              selectedRows.push(row);
            }
      ...
      processedRows: function processedRows() {
        ...
        if (this.globalSearchAllowed) {
          ...
          var allRows = [];
          each__default['default'](this.filteredRows, function (headerRow) {
            allRows.push.apply(allRows, _toConsumableArray(headerRow.children));
          });
          var filteredRows = [];
          each__default['default'](allRows, function (row) {
            each__default['default'](_this.columns, function (col) {
          ...
          each__default['default'](this.filteredRows, function (headerRow) {
            ...
            var children = filter__default['default'](filteredRows, ['vgt_id', i]);

            if (children.length) {
              var newHeaderRow = cloneDeep__default['default'](headerRow);
      ...
      paginated: function paginated() {
        ...
        var paginatedRows = [];
        each__default['default'](this.processedRows, function (childRows) {
          var _paginatedRows;
        ...
        paginatedRows.forEach(function (flatRow) {
          ...
          if (flatRow.vgt_header_id !== undefined) {
            ...
            var newHeaderRow = cloneDeep__default['default'](flatRow);
            ...
            if (!hRow) {
              ...
              if (hRow) {
                hRow = cloneDeep__default['default'](hRow);
                hRow.children = [];
      ...
      originalRows: function originalRows() {
        var rows = cloneDeep__default['default'](this.rows);
        var nestedRows = [];
        ...
        var index = 0;
        each__default['default'](nestedRows, function (headerRow, i) {
      ...
      typedColumns: function typedColumns() {
        var columns = assign__default['default'](this.columns, []);
    ...
    methods: {
      ...
      filterRows: function filterRows(columnFilters) {
        ...
        var computedRows = cloneDeep__default['default'](this.originalRows); // do we have a filter to care about?
        ...
        if (this.columnFilters && Object.keys(this.columnFilters).length) {
          ...
          var _loop = function _loop(i) {
            ...
            if (_this9.columnFilters[col.field]) {
              computedRows = each__default['default'](computedRows, function (headerRow) {
      ...
      handleGrouped: function handleGrouped(originalRows) {
        ...
        each__default['default'](originalRows, function (headerRow, i) {
          ...
          each__default['default'](headerRow.children, function (childRow) {
            childRow.vgt_id = i;
          });
        });
        return originalRows;
